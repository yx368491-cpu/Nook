...
| **代码版本** | `v0.5.0 + M3-1 (c88c076) + M3-2 (75d7300) + M3-3 (70d6e41) + M3-4 (0fa9cbd) + M3-5 (d1915f2) + M4-1/2 (d39dbbe) + M4-3 (9fa1968) + M4-4 (ea2f2ef) + M4-5 (7f2b47a) + M4-6 (33e4179 + fixup 6eaa861) + M4-7 (0111398 + RT closure 075b4b1 + 540165a) + M4-7.1 polish (7e3ec3f) + **M4-8 (d320483) + M5-1 (dadcb01) + M5-2 (bf52d90) + M5-4 (d6c0ae2) + M5-5 (5e7fab3) + M5-6 (75c286e) · S40.0 batch · annotated tag `v0.5.0+M5.6`**` |
...
| 🟢 下一步 | **M5-7 · 50MB upload progress bar (F-MSG-03)** | 50MB 直传 supabase.storage attachments bucket + UI 进度条 + drag-drop affordance overlay + i18n chat.uploadProgress.{start,complete} × 2 lang |
...
| **Docker 架构决策 + S40.0 docs sync + version tag** | 🟢 **v0.5.0+M5.6** annotated tag pushed at commit `75c286e` (S40.0 · 2026-06-29) — 6 uncommitted milestones landed as discrete commits (M4-8 / M5-1 / M5-2 / M5-4 / M5-5 / M5-6) + docs sync + CHANGELOG Unreleased → [v0.5.0+M5.6] promote |
